...
const FDCollectionsComponent = () => {
    return (
        ...
        <div className="collection-all">
           ...
           <Link to='/fdCollections/1/'><EachBox image={Shoes1} title="Collection title" brandname="Brand name" brandimg={Shoes1} number1="수량" number2="최저 거래가" number3="123개" number4="0.019" number5="#서머" number6=""/></Link>

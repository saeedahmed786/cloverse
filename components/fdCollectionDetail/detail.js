...
import './detail.css'
import GridView from "./collection_grid";
...
const CollectionDetail = () => {
    ...
    var elem2 = document.getElementById("grid")
    ...
    return (
        <Fragment>
            <div className="black-blank">
                <Link to="/designer/">
                    <Image width="10px" height="10px" layout="responsive" src={ProfileImg} alt="profileimg" className="designer-profile" />
                </Link>
            </div>
                        ...
                        <div>
                            ...
                            <div style={{ display: "flex", margin: "20px 0", flexWrap: "wrap" }}>
                                ...
                                <div className="marginright20">
                                    ...
                                    <div className="lower-first-row" ><img src={BlueIcon} alt="blueicon" style={{ display: 'inline-block' }} /> 1,366</div>
                                </div>
                                <div className="marginright20">
                                    <div className="grey-text fonts-16 fontw-500">거래량</div>
                                    <div className="lower-first-row"><img src={BlueIcon} alt="blueicon" style={{ display: 'inline-block' }} />  2,566</div>
                                </div>
                            </div>
                        </div>

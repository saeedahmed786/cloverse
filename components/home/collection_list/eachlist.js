    ...
    <div className="each-list w-100">
      <div className="component">
        ...
        <div>
          ...
          <div>
            ...
            <span className='fonts-14 fontw-700 d-flex gap-1' style={{ color: "#757575" }}>
              <Image src={BlueIcon} width="16px" height="16px" alt="blue-icon" className="fonts-16" />
              <span>
                16,58
              </span>
            </span>
        ...
        <div>
          ...
          <div className='right2-2'><Image src={BlueIcon} width="16px" height="16px" alt="blue-icon" className="fonts-16" /> 133,070</div>
        </div>
      </div>
    </div>
  )
